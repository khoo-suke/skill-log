      ...
      <div className={styles.terms}>
        <h2>利用規約</h2>
          <p className={styles.mb60}>
            この利用規約（以下、「本規約」といいます。）は、SkillLog（以下、「当社」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
          </p>
          <h3>第1条（適用）</h3>
          <ul className={styles.mb60}>
            <li>
          ...
          <ul className={styles.mb60}>
            ...
            <li>
              本サービスの内容等、本サービスに含まれる著作権、商標権ほか知的財</li>
            <li>産権を侵害する行為</li>
            <li>
          ...
          <p className={styles.textAlignR}>以上</p>
      </div>
    </Wrapper>
    </>
  );
